                            ...
                            {taskList.map((t) => (
                                <div key={t.id} className="col-md-6">
                                    <div style={{ background: "#fff", borderRadius: 16, padding: 20, marginBottom: 18, boxShadow: "0 2px 8px rgba(0,0,0,0.08)" }}>
                                        ...
                                        <p style={{ color: "#222", marginBottom: 8 }}><strong>Dirección:</strong> {t.address || ""}</p>
                                        <p style={{ color: "#222", marginBottom: 8 }}><strong>Latitud:</strong> {t.lat || "-"}</p>
                                        <p style={{ color: "#222", marginBottom: 8 }}><strong>Longitud:</strong> {t.lng || "-"}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
