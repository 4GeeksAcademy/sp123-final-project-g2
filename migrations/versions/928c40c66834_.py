...
Revision ID: 928c40c66834
Revises: 
Create Date: 2026-02-16 18:15:52.618257
...
def upgrade():
    ...
    sa.Column('points', sa.Integer(), nullable=False),
    sa.Column('point_type', sa.Enum('lesson', 'module', 'course', name='type_user_points'), nullable=False),
    ...
    sa.Column('resource_type', sa.Enum('video', 'image', 'gif', 'animation', 'document', name='type_multimedia_resources'), nullable=False),
